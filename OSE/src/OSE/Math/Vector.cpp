...
namespace OSE {
	//vec2
	vec2::vec() : x(0), y(0) {}
	vec2::vec(t_float x, t_float y) : x(x), y(y) {}
	vec2::vec(t_float v) : x(v), y(v) {}
	...
	//vec3
	vec3::vec() : x(0), y(0), z(0) {}
	vec3::vec(t_float x, t_float y, t_float z) : x(x), y(y), z(z) {}
	vec3::vec(t_float v) : x(v), y(v), z(v) {}
	vec3::vec(vec2 xy, t_float z) : x(xy.x), y(xy.y), z(z) {}
	vec3::vec(t_float x, vec2 yz) : x(x), y(yz.x), z(yz.y) {}
	...
	//vec4
	vec4::vec() : x(0), y(0), z(0), w(0) {}
	vec4::vec(t_float x, t_float y, t_float z, t_float w) : x(x), y(y), z(z), w(w) {}
	vec4::vec(t_float v) : x(v), y(v), z(v), w(v) {}
	vec4::vec(vec2 xy, t_float z, t_float w) : x(xy.x), y(xy.y), z(z), w(w) {}
	vec4::vec(t_float x, vec2 yz, t_float w) : x(x), y(yz.x), z(yz.y), w(w) {}
	vec4::vec(t_float x, t_float y, vec2 zw) : x(x), y(y), z(zw.x), w(zw.y) {}
	vec4::vec(vec3 xyz, t_float w) : x(xyz.x), y(xyz.y), z(xyz.z), w(w) {}
	vec4::vec(t_float x, vec3 yzw) : x(x), y(yzw.x), z(yzw.y), w(yzw.z) {}
